<template>
  <div>
    <el-dialog :visible="showDetail" :before-close="handleClose" width="1200px" height="700">
      <div slot="title" style="font-size:24px;color:#4a5a7f;font-family:Microsoft YaHei;">商品详情</div>
